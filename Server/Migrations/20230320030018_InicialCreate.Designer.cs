...
namespace JoyaBlazor.Server.Migrations
{
    ...
    [Migration("20230320030018_InicialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JoyaBlazor.Server.Models.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JoyaBlazor.Server.Models.UsuarioRol", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JoyaBlazor.Server.Models.Usuario", b =>
                {
                    b.HasOne("JoyaBlazor.Server.Models.UsuarioRol", "UsuarioRol")
                        .WithMany()
